...
## Demo
Check out a [live demo on StackBlitz](https://stackblitz.com/edit/easy-dates-demo?file=src/App.js)
...
### `getDuration`
Returns the amount of time between two dates as a Unix timestamp. 
